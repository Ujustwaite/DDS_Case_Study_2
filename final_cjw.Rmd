...
colnames(dept_role) <- c("Department", "Job Role", "Employee Count","id")
```
...
#Calc Percentage
# dept_role$AttrDecimal <- dept_role$`Employee Count`/sum(dept_role$`Employee Count`)
# dept_role$Percentage <- percent(dept_role$AttrDecimal)
